...
namespace BackendTest.Service {
    ...
    public class DataSeriesServiceTest {
        ...
        public void CreateEstimatedActualInfectedPerPopulation_OneDataPoint_NormalDistributionInPast() {
            ...
            dataSeries[0].DataPoints[0].YValue.Should().BeApproximately(peak * 0.0004, 1e-7);
            dataSeries[0].DataPoints[1].XValue.Should().Be(new DateTime(2020, 1, 12));
            dataSeries[0].DataPoints[1].YValue.Should().BeApproximately(peak * 0.0009, 1e-7);
            dataSeries[0].DataPoints[2].XValue.Should().Be(new DateTime(2020, 1, 13));
            dataSeries[0].DataPoints[2].YValue.Should().BeApproximately(peak * 0.0025, 1e-7);
            dataSeries[0].DataPoints[3].XValue.Should().Be(new DateTime(2020, 1, 14));
            dataSeries[0].DataPoints[3].YValue.Should().BeApproximately(peak * 0.006, 1e-7);
            dataSeries[0].DataPoints[4].XValue.Should().Be(new DateTime(2020, 1, 15));
            dataSeries[0].DataPoints[4].YValue.Should().BeApproximately(peak * 0.0129, 1e-7);
            dataSeries[0].DataPoints[5].XValue.Should().Be(new DateTime(2020, 1, 16));
            dataSeries[0].DataPoints[5].YValue.Should().BeApproximately(peak * 0.025, 1e-7);
            dataSeries[0].DataPoints[6].XValue.Should().Be(new DateTime(2020, 1, 17));
            dataSeries[0].DataPoints[6].YValue.Should().BeApproximately(peak * 0.0434, 1e-7);
            dataSeries[0].DataPoints[7].XValue.Should().Be(new DateTime(2020, 1, 18));
            dataSeries[0].DataPoints[7].YValue.Should().BeApproximately(peak * 0.0674, 1e-7);
            dataSeries[0].DataPoints[8].XValue.Should().Be(new DateTime(2020, 1, 19));
            dataSeries[0].DataPoints[8].YValue.Should().BeApproximately(peak * 0.0938, 1e-7);
            dataSeries[0].DataPoints[9].XValue.Should().Be(new DateTime(2020, 1, 20));
            dataSeries[0].DataPoints[9].YValue.Should().BeApproximately(peak * 0.1169, 1e-7);
            dataSeries[0].DataPoints[10].XValue.Should().Be(new DateTime(2020, 1, 21));
            dataSeries[0].DataPoints[10].YValue.Should().BeApproximately(peak * 0.1306, 1e-7);
            dataSeries[0].DataPoints[11].XValue.Should().Be(new DateTime(2020, 1, 22));
            dataSeries[0].DataPoints[11].YValue.Should().BeApproximately(peak * 0.1306, 1e-7);
            dataSeries[0].DataPoints[12].XValue.Should().Be(new DateTime(2020, 1, 23));
            dataSeries[0].DataPoints[12].YValue.Should().BeApproximately(peak * 0.0938, 1e-7);
            dataSeries[0].DataPoints[13].XValue.Should().Be(new DateTime(2020, 1, 24));
            dataSeries[0].DataPoints[13].YValue.Should().BeApproximately(peak * 0.0938, 1e-7);
            dataSeries[0].DataPoints[14].XValue.Should().Be(new DateTime(2020, 1, 25));
            dataSeries[0].DataPoints[14].YValue.Should().BeApproximately(peak * 0.0674, 1e-7);
            dataSeries[0].DataPoints[15].XValue.Should().Be(new DateTime(2020, 1, 26));
            dataSeries[0].DataPoints[15].YValue.Should().BeApproximately(peak * 0.0434, 1e-7);
            dataSeries[0].DataPoints[16].XValue.Should().Be(new DateTime(2020, 1, 27));
            dataSeries[0].DataPoints[16].YValue.Should().BeApproximately(peak * 0.025, 1e-7);
            dataSeries[0].DataPoints[17].XValue.Should().Be(new DateTime(2020, 1, 28));
            dataSeries[0].DataPoints[17].YValue.Should().BeApproximately(peak * 0.0129, 1e-7);
            dataSeries[0].DataPoints[18].XValue.Should().Be(new DateTime(2020, 1, 29));
            dataSeries[0].DataPoints[18].YValue.Should().BeApproximately(peak * 0.006, 1e-7);
            dataSeries[0].DataPoints[19].XValue.Should().Be(new DateTime(2020, 1, 30));
            dataSeries[0].DataPoints[19].YValue.Should().BeApproximately(peak * 0.0025, 1e-7);
            dataSeries[0].DataPoints[20].XValue.Should().Be(new DateTime(2020, 1, 31));
            dataSeries[0].DataPoints[20].YValue.Should().BeApproximately(peak * 0.0013, 1e-7);
        }
    }
}
